...
ActiveRecord::Schema.define(version: 20_220_808_182_806) do
  ...
  create_table 'composite_content_blocks', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[blockable_type blockable_id], name: 'index_composite_content_blocks_on_blockable'
  ...
  create_table 'composite_content_slots', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[parent_type parent_id], name: 'index_composite_content_slots_on_parent'
